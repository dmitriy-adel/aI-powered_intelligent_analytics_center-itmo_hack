// Визуальные словари, синхронизированные с дизайн-системой (см. скрин 1).
// Если бэкенд пришлёт категорию/статус, которых здесь нет, используется
// нейтральный фолбэк — ничего не падает.
